...
def get_unidades_dashboard(db: Session, filters: dict) -> list[dict]:
    q = select(
        ...
        func.max(FactUnidadeMensal.mes_incompleto),
        func.max(FactUnidadeMensal.dados_inconsistentes),
...
def get_profissionais_dashboard(db: Session, filters: dict) -> list[dict]:
    q = select(
        ...
        func.max(FactProducaoProfissionalMensal.mes_incompleto),
        func.max(FactProducaoProfissionalMensal.dados_inconsistentes),
